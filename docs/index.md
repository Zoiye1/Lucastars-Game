...
children:
    ...
    - dod.md
    - game-design-document/index.md
    - infrastructure-design-document/index.md
---
# Documentatie
Tijdens het project is het belangrijk allerlei informatie vast te leggen, zowel voor jezelf als voor LucaStars. Denk hierbij aan je Game Design Document, Technische documentatie, Think-Make-Check cycli, Retrospectives, Portfolio, Samenwerkingscontract, enzovoorts.
